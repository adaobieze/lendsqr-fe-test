    ...
    return (
        <>
            ...
            <div className={styles.userPersonalInfoTab}>
                ...
                <div className={`${styles.infoGrid} ${styles.educationAndEmployment}`}>
                    <div className={styles.infoItem}>
            ...
            <div className={styles.userPersonalInfoTab}>
                ...
                <div className={`${styles.infoGrid} ${styles.socials}`}>
                    <div className={styles.infoItem}>
            ...
            <div className={styles.userPersonalInfoTab}>
                ...
                {userDetails?.guarantors.map((guarantor, index) => (
                    <div key={index}>
                        <div className={`${styles.infoGrid} ${styles.guarantors}`}>
                            <div className={styles.infoItem}>
                                <p className={styles.label}>Full Name</p>
